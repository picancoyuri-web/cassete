...
app.listen(PORT, () => {
  ...
  // roda uma vez ao subir o servidor e depois a cada 24h, criando
  // notificações de "memória" pra entradas de diário de 1 ano atrás
  checkMemories();
  setInterval(checkMemories, 24 * 60 * 60 * 1000);
});
